...
public class AdminPanel extends JPanel {
	...
	public AdminPanel(LibraryMainPageGUI mainGUI, List<Book> bookList) {
		...
		DefaultTableModel bookInfoModel =new DefaultTableModel(data, new Object[]{ "Book Title", "Author", "Genre", "Total Copies", "Num Rented" }); 
		bookInfotable = new JTable(bookInfoModel);
		
		for(Book book: bookList) {
			bookInfoModel.addRow(new Object[] {book.getTitle(), book.getAuthor(), book.getGenre(), String.valueOf(book.getCopies().size()), String.valueOf(book.getAvailableCopies().size())});
		}
